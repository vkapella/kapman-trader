...
from core.metrics.b2_wyckoff_structural_events_job import (
    DEFAULT_HEARTBEAT_TICKERS,
    run_wyckoff_structural_events_job,
)


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="KapMan B2r2: Persist canonical Wyckoff structural events into daily_snapshots"
    )
...
def _configure_logging(verbose: bool) -> logging.Logger:
    log = logging.getLogger("kapman.b2")
    log.handlers.clear()
    log.propagate = False
