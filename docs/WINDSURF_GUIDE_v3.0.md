...
3. Directory Structure (v3.0 Standard)  
4. Environment Model (dev / test / prod)  
5. Daily Windsurf Session Initialization  
6. Sprint Workflow (0.5 → 4)  
7. Coding Prompts  
8. Testing Workflow (TDD & Coverage Rules)  
...
4. **Tell Cascade to read both:**
   - `docs/KAPMAN_ARCHITECTURE_v3.0.md`
   - `docs/WINDSURF_GUIDE_v3.0.md`  
...
| Document | Purpose |
|----------|----------|
| **KAPMAN_ARCHITECTURE_v3.0.md** | Defines system architecture, pipeline, DB schema, sprints |
| **WINDSURF_GUIDE_v3.0.md** | Defines development workflow, prompts, coding procedures |
...
1. KAPMAN_ARCHITECTURE_v3.0.md
2. docs/WINDSURF_GUIDE.md (v3.0)

Confirm you understand:
- The 5-phase pipeline (S3 OHLCV → Options → Metrics → Wyckoff → Recommendations)
...
# 7. CODING PROMPTS (FULL TEMPLATES)

### 7.1 Pipeline Component Prompt

```
We are building Kapman Trading System v3.0.
...
# 8. TESTING WORKFLOW (TDD & COVERAGE)
...
| Issue | Cause | Fix |
|-------|--------|------|
| Missing folders | Repo not aligned with v3.0 | Rebuild directory tree |
...
```
KAPMAN – WINDSURF QUICK REFERENCE v3.0

Load Both:
1. KAPMAN_ARCHITECTURE_v3.0.md
2. WINDSURF_GUIDE_v3.0.md
